...
public class DuplicateInArray {
    ...
    public int repeatedNumber(final List<Integer> a) {
        int max = (int) Math.sqrt(a.size() - 1);
        if (max * max < a.size() - 1) {
            max++;
        }
        ...
        for (Integer i : a) {
            if (i >= bucket * max && i <= (bucket + 1) * max) {
